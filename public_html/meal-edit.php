        ...
        <div class="row">
            <div class="col-lg-4" style="max-width: 40em;">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="recipeCategory">
                    ...
                    <input type="text" placeholder="new category name" class="form-control mt-3 collapse" id="newCategory">
                </div>
